              ...
              >
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-[#008564] font-bold">{totalWins}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="border-t border-[#e0e0e0]">
                    ...
                    {h2h && d2 && (
                      <div className="px-6 py-6 border-b border-[#e0e0e0] bg-[#f5f5f5]">
                        ...
                        {/* H2H bar */}
                        <div className="w-full h-3 bg-[#e0e0e0] rounded-full overflow-hidden mb-4">
                          <div
                          ...
                          <thead>
                            <tr className="border-b border-[#e0e0e0]">
                              ...
                              {races && races.length > 0 ? (
                                ...
                                <th className="px-3 py-2 text-center text-[#6c6d6f] text-xs font-bold uppercase">-</th>
                              )}
                            </tr>
                          </thead>
                          <tbody>
                            {team.drivers.map((driver) => (
                              <tr key={driver.id} className="border-b border-[#e0e0e0]">
                                ...
                                {driver.raceByRace && driver.raceByRace.length > 0 ? (
                                  ...
                                  <td className="px-3 py-2 text-center text-[#6c6d6f] font-semibold">-</td>
                                )}
                              </tr>
                            ))}
                          </tbody>
                          ...
                          <div key={driver.id} className="bg-[#f5f5f5] border border-[#e0e0e0] rounded-lg p-5">
                            ...
                            <div className="grid grid-cols-2 gap-3 text-sm">
                              ...
                              <div>
                                ...
                                <div className="text-[#008564] font-bold">
